...
exports.update = function(req, res) {
  ...
  blisting.itemname = req.body.itemname;
  blisting.itemdesc = req.body.itemdesc;
  blisting.itemprice = req.body.itemprice;
  blisting.itemexp = req.body.itemexp;
  blisting.itemqty = req.body.itemqty;
  blisting.itemcode = req.body.itemcode;
  blisting.itempic = req.body.itempic;
  blisting.ibodnum = req.body.ibodnum;
  blisting.ivenuser = req.body.ivenuser;
...
/* Retreive all the listings, sorted alphabetically by blisting item */

exports.list = function(req, res) {
//  var blisting = req.blisting;
  bListing.find().sort('itemname').exec(function(err, blistings) {
    if(err) {
//      console.log(err);
      res.status(400).send(err);
    }
...
/*
  Middleware: find a isting by its ID, then pass it to the next request handler.
